...
#0 Preparing data ---------------------------------------------
line<-read.csv2("C:/Users/Kerry/Desktop/Master-thesis/data/line transects/line.csv")
...
#-------------------------------------------------------------------------
#amount total
PM1<-nrow(line %>% filter(transect_id %in% "PM1"))
#amount Actinacis
PM1.act<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Actinacis"))*100)/PM1
#amount Astreopora
PM1.ast<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Astreopora"))*100)/PM1
#amount Bioclastic
PM1.bio<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Bioclastic sediment"))*100)/PM1
#amount Bivalve
PM1.biv<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Bivalve"))*100)/PM1
#amount Bivalve boring
PM1.biv.b<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Bivalve boring"))*100)/PM1
#amount Caulastrea
PM1.cau<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Caulastrea"))*100)/PM1
#amount CCA
PM1.cca<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "CCA"))*100)/PM1
#amount Cement
PM1.cem<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Cement"))*100)/PM1
#amount Coral
PM1.cor<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Coral"))*100)/PM1
#amount Coralline algae
PM1.cor.a<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Coralline algae"))*100)/PM1
#amount Favites
PM1.fav<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Favites"))*100)/PM1
#amount Glauconite
PM1.glau<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Glauconite"))*100)/PM1
#amount Hydnophora
PM1.hyd<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Hydnophora"))*100)/PM1
#amount Montastrea
PM1.mon<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Montastrea"))*100)/PM1
#amount na
PM1.na<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "na"))*100)/PM1
#amount Pavona
PM1.pav<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Pavona"))*100)/PM1
#amount Porites
PM1.por<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Porites"))*100)/PM1
#amount Poritid
PM1.pd<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Poritid"))*100)/PM1
#amount Sediment
PM1.sed<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Sediment"))*100)/PM1
#amount Shale
PM1.sha<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Shale"))*100)/PM1
#amount Siderastrea
PM1.sid<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Siderastrea"))*100)/PM1
#amount Stylophora
PM1.sty<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Stylophora"))*100)/PM1
#amount Tarbellastraea
PM1.tar<-(nrow(line %>% filter(transect_id == "PM1" & point_id == "Tarbellastraea"))*100)/PM1


PM1.data<-data.frame(PM1,PM1.act, PM1.ast,PM1.bio,PM1.biv,PM1.biv.b,
                      PM1.cau,PM1.cca,PM1.cem,PM1.cor,PM1.cor.a,PM1.fav,PM1.glau,PM1.hyd,PM1.mon, PM1.na,PM1.pav,PM1.pd,
                      PM1.por,PM1.sed,PM1.sha,PM1.sid,PM1.sty,PM1.tar)

write.xlsx(x = PM1.data,"PM1.xlsx")
...
#--------------------------------------------------------------------------
#amount total
PM2<-nrow(line %>% filter(transect_id %in% "PM2"))
#amount Actinacis
PM2.act<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Actinacis"))*100)/PM2
#amount Astreopora
PM2.ast<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Astreopora"))*100)/PM2
#amount Bioclastic
PM2.bio<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Bioclastic sediment"))*100)/PM2
#amount Bivalve
PM2.biv<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Bivalve"))*100)/PM2
#amount Bivalve boring
PM2.biv.b<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Bivalve boring"))*100)/PM2
#amount Caulastrea
PM2.cau<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Caulastrea"))*100)/PM2
#amount CCA
PM2.cca<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "CCA"))*100)/PM2
#amount Cement
PM2.cem<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Cement"))*100)/PM2
#amount Coral
PM2.cor<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Coral"))*100)/PM2
#amount Coralline algae
PM2.cor.a<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Coralline algae"))*100)/PM2
#amount Favites
PM2.fav<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Favites"))*100)/PM2
#amount Glauconite
PM2.glau<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Glauconite"))*100)/PM2
#amount Hydnophora
PM2.hyd<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Hydnophora"))*100)/PM2
#amount Montastrea
PM2.mon<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Montastrea"))*100)/PM2
#amount na
PM2.na<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "na"))*100)/PM2
#amount Pavona
PM2.pav<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Pavona"))*100)/PM2
#amount Porites
PM2.por<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Porites"))*100)/PM2
#amount Poritid
PM2.pd<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Poritid"))*100)/PM2
#amount Sediment
PM2.sed<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Sediment"))*100)/PM2
#amount Shale
PM2.sha<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Shale"))*100)/PM2
#amount Siderastrea
PM2.sid<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Siderastrea"))*100)/PM2
#amount Stylophora
PM2.sty<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Stylophora"))*100)/PM2
#amount Tarbellastraea
PM2.tar<-(nrow(line %>% filter(transect_id == "PM2" & point_id == "Tarbellastraea"))*100)/PM2


PM2.data<-data.frame(PM2,PM2.act, PM2.ast,PM2.bio,PM2.biv,PM2.biv.b,
                      PM2.cau,PM2.cca,PM2.cem,PM2.cor,PM2.cor.a,PM2.fav,PM2.glau,PM2.hyd,PM2.mon, PM2.na,PM2.pav,PM2.pd,
                      PM2.por,PM2.sed,PM2.sha,PM2.sid,PM2.sty,PM2.tar)


write.xlsx(x = PM2.data,"PM2.xlsx")
...
#---------------------------------------------------------------------------
#amount total
PM3<-nrow(line %>% filter(transect_id %in% "PM3"))
#amount Actinacis
PM3.act<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Actinacis"))*100)/PM3
#amount Astreopora
PM3.ast<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Astreopora"))*100)/PM3
#amount Bioclastic
PM3.bio<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Bioclastic sediment"))*100)/PM3
#amount Bivalve
PM3.biv<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Bivalve"))*100)/PM3
#amount Bivalve boring
PM3.biv.b<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Bivalve boring"))*100)/PM3
#amount Caulastrea
PM3.cau<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Caulastrea"))*100)/PM3
#amount CCA
PM3.cca<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "CCA"))*100)/PM3
#amount Cement
PM3.cem<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Cement"))*100)/PM3
#amount Coral
PM3.cor<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Coral"))*100)/PM3
#amount Coralline algae
PM3.cor.a<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Coralline algae"))*100)/PM3
#amount Favites
PM3.fav<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Favites"))*100)/PM3
#amount Glauconite
PM3.glau<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Glauconite"))*100)/PM3
#amount Hydnophora
PM3.hyd<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Hydnophora"))*100)/PM3
#amount Montastrea
PM3.mon<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Montastrea"))*100)/PM3
#amount na
PM3.na<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "na"))*100)/PM3
#amount Pavona
PM3.pav<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Pavona"))*100)/PM3
#amount Porites
PM3.por<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Porites"))*100)/PM3
#amount Poritid
PM3.pd<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Poritid"))*100)/PM3
#amount Sediment
PM3.sed<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Sediment"))*100)/PM3
#amount Shale
PM3.sha<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Shale"))*100)/PM3
#amount Siderastrea
PM3.sid<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Siderastrea"))*100)/PM3
#amount Stylophora
PM3.sty<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Stylophora"))*100)/PM3
#amount Tarbellastraea
PM3.tar<-(nrow(line %>% filter(transect_id == "PM3" & point_id == "Tarbellastraea"))*100)/PM3


PM3.data<-data.frame(PM3,PM3.act, PM3.ast,PM3.bio,PM3.biv,PM3.biv.b,
                      PM3.cau,PM3.cca,PM3.cem,PM3.cor,PM3.cor.a,PM3.fav,PM3.glau,PM3.hyd,PM3.mon, PM3.na,PM3.pav,PM3.pd,
                      PM3.por,PM3.sed,PM3.sha,PM3.sid,PM3.sty,PM3.tar)


write.xlsx(x = PM3.data,"PM3.xlsx")
...
#---------------------------------------------------------------------------
#amount total
PM4<-nrow(line %>% filter(transect_id %in% "PM4"))
#amount Actinacis
PM4.act<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Actinacis"))*100)/PM4
#amount Astreopora
PM4.ast<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Astreopora"))*100)/PM4
#amount Bioclastic
PM4.bio<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Bioclastic sediment"))*100)/PM4
#amount Bivalve
PM4.biv<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Bivalve"))*100)/PM4
#amount Bivalve boring
PM4.biv.b<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Bivalve boring"))*100)/PM4
#amount Caulastrea
PM4.cau<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Caulastrea"))*100)/PM4
#amount CCA
PM4.cca<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "CCA"))*100)/PM4
#amount Cement
PM4.cem<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Cement"))*100)/PM4
#amount Coral
PM4.cor<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Coral"))*100)/PM4
#amount Coralline algae
PM4.cor.a<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Coralline algae"))*100)/PM4
#amount Favites
PM4.fav<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Favites"))*100)/PM4
#amount Glauconite
PM4.glau<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Glauconite"))*100)/PM4
#amount Hydnophora
PM4.hyd<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Hydnophora"))*100)/PM4
#amount Montastrea
PM4.mon<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Montastrea"))*100)/PM4
#amount na
PM4.na<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "na"))*100)/PM4
#amount Pavona
PM4.pav<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Pavona"))*100)/PM4
#amount Porites
PM4.por<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Porites"))*100)/PM4
#amount Poritid
PM4.pd<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Poritid"))*100)/PM4
#amount Sediment
PM4.sed<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Sediment"))*100)/PM4
#amount Shale
PM4.sha<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Shale"))*100)/PM4
#amount Siderastrea
PM4.sid<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Siderastrea"))*100)/PM4
#amount Stylophora
PM4.sty<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Stylophora"))*100)/PM4
#amount Tarbellastraea
PM4.tar<-(nrow(line %>% filter(transect_id == "PM4" & point_id == "Tarbellastraea"))*100)/PM4


PM4.data<-data.frame(PM4,PM4.act, PM4.ast,PM4.bio,PM4.biv,PM4.biv.b,
                      PM4.cau,PM4.cca,PM4.cem,PM4.cor,PM4.cor.a,PM4.fav,PM4.glau,PM4.hyd,PM4.mon, PM4.na,PM4.pav,PM4.pd,
                      PM4.por,PM4.sed,PM4.sha,PM4.sid,PM4.sty,PM4.tar)


write.xlsx(x = PM4.data,"PM4.xlsx")
...
#---------------------------------------------------------------------------
#amount total
PM5<-nrow(line %>% filter(transect_id %in% "PM5"))
#amount Actinacis
PM5.act<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Actinacis"))*100)/PM5
#amount Astreopora
PM5.ast<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Astreopora"))*100)/PM5
#amount Bioclastic
PM5.bio<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Bioclastic sediment"))*100)/PM5
#amount Bivalve
PM5.biv<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Bivalve"))*100)/PM5
#amount Bivalve boring
PM5.biv.b<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Bivalve boring"))*100)/PM5
#amount Caulastrea
PM5.cau<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Caulastrea"))*100)/PM5
#amount CCA
PM5.cca<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "CCA"))*100)/PM5
#amount Cement
PM5.cem<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Cement"))*100)/PM5
#amount Coral
PM5.cor<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Coral"))*100)/PM5
#amount Coralline algae
PM5.cor.a<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Coralline algae"))*100)/PM5
#amount Favites
PM5.fav<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Favites"))*100)/PM5
#amount Glauconite
PM5.glau<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Glauconite"))*100)/PM5
#amount Hydnophora
PM5.hyd<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Hydnophora"))*100)/PM5
#amount Montastrea
PM5.mon<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Montastrea"))*100)/PM5
#amount na
PM5.na<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "na"))*100)/PM5
#amount Pavona
PM5.pav<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Pavona"))*100)/PM5
#amount Porites
PM5.por<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Porites"))*100)/PM5
#amount Poritid
PM5.pd<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Poritid"))*100)/PM5
#amount Sediment
PM5.sed<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Sediment"))*100)/PM5
#amount Shale
PM5.sha<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Shale"))*100)/PM5
#amount Siderastrea
PM5.sid<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Siderastrea"))*100)/PM5
#amount Stylophora
PM5.sty<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Stylophora"))*100)/PM5
#amount Tarbellastraea
PM5.tar<-(nrow(line %>% filter(transect_id == "PM5" & point_id == "Tarbellastraea"))*100)/PM5


PM5.data<-data.frame(PM5,PM5.act, PM5.ast,PM5.bio,PM5.biv,PM5.biv.b,
                      PM5.cau,PM5.cca,PM5.cem,PM5.cor,PM5.cor.a,PM5.fav,PM5.glau,PM5.hyd,PM5.mon, PM5.na,PM5.pav,PM5.pd,
                      PM5.por,PM5.sed,PM5.sha,PM5.sid,PM5.sty,PM5.tar)


write.xlsx(x = PM5.data,"PM5.xlsx")
...
#---------------------------------------------------------------------------
#amount total
PM6<-nrow(line %>% filter(transect_id %in% "PM6"))
#amount Actinacis
PM6.act<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Actinacis"))*100)/PM6
#amount Astreopora
PM6.ast<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Astreopora"))*100)/PM6
#amount Bioclastic
PM6.bio<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Bioclastic sediment"))*100)/PM6
#amount Bivalve
PM6.biv<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Bivalve"))*100)/PM6
#amount Bivalve boring
PM6.biv.b<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Bivalve boring"))*100)/PM6
#amount Caulastrea
PM6.cau<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Caulastrea"))*100)/PM6
#amount CCA
PM6.cca<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "CCA"))*100)/PM6
#amount Cement
PM6.cem<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Cement"))*100)/PM6
#amount Coral
PM6.cor<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Coral"))*100)/PM6
#amount Coralline algae
PM6.cor.a<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Coralline algae"))*100)/PM6
#amount Favites
PM6.fav<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Favites"))*100)/PM6
#amount Glauconite
PM6.glau<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Glauconite"))*100)/PM6
#amount Hydnophora
PM6.hyd<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Hydnophora"))*100)/PM6
#amount Montastrea
PM6.mon<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Montastrea"))*100)/PM6
#amount na
PM6.na<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "na"))*100)/PM6
#amount Pavona
PM6.pav<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Pavona"))*100)/PM6
#amount Porites
PM6.por<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Porites"))*100)/PM6
#amount Poritid
PM6.pd<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Poritid"))*100)/PM6
#amount Sediment
PM6.sed<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Sediment"))*100)/PM6
#amount Shale
PM6.sha<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Shale"))*100)/PM6
#amount Siderastrea
PM6.sid<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Siderastrea"))*100)/PM6
#amount Stylophora
PM6.sty<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Stylophora"))*100)/PM6
#amount Tarbellastraea
PM6.tar<-(nrow(line %>% filter(transect_id == "PM6" & point_id == "Tarbellastraea"))*100)/PM6


PM6.data<-data.frame(PM6,PM6.act, PM6.ast,PM6.bio,PM6.biv,PM6.biv.b,
                      PM6.cau,PM6.cca,PM6.cem,PM6.cor,PM6.cor.a,PM6.fav,PM6.glau,PM6.hyd,PM6.mon, PM6.na,PM6.pav,PM6.pd,
                      PM6.por,PM6.sed,PM6.sha,PM6.sid,PM6.sty,PM6.tar)


write.xlsx(x = PM6.data,"PM6.xlsx")
